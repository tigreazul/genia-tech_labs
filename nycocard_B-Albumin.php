...
<body>
										...
										<div class="container">
											...
											<div class="description-box">
												...
												<div class="text-holder">
													<p>La Albumina es una peque&#241;a prote&#237;na presente en altas concentraciones 
													en plasma. Normalmente solo peque&#241;as cantidades de albumina son excretadas en la orina</p>
													<p>
													Elevaciones sostenidas en la concentraci&#243;n de albumina urinaria son conocidas como albuminuria. 
													Las elevaciones sostenidas en la concentraci&#243;n de albumina urinaria se conocen como micro albuminuria.
													La micro albuminuria tambi&#233;n se define como la tasa de excreci&#243;n de albumina urinaria (AER) entre 20-200 
													ug/min en por lo menos dos de tres muestras de orina dentro de u periodo de seis meses. Siendo el primer 
													signo cl&#237;nico de la enfermedad renal del diab&#233;tico y enfermedad cardiovascular, la micro albuminuria es 
													ideal tanto para la determinaci&#243;n de riesgo como del monitoreo.
													</p>
													...
													<!-- end boton -->
														<div style="margin-right:-9px">
															<div style="width:100px; float:left;margin-right:-21px">
																<a href="http://www.genia-tech.com/demo/pdf/CATALOGO_Alere_U-Albumin.pdf" target="_blank" class="more sub-more wishlist"><span>Ver </span></a>
																
															</div>
															<div style="width:100px; float:left">
																<a href="http://www.alere.com/EN_US/" target="_blank" class="more sub-more compare"><span>Alere</span></a>
															</div>
														</div>
														<!-- end boton -->
													</div>
    ...
    <div class="clearfix" style="margin-left:46px;float:left">
        <a href="imgProd/U-ALBUMIN/U-ALBUMIN.jpg" class="jqzoom" rel='gal1'  title="Genia-tech" >
            <img src="imgProd/U-ALBUMIN/U-ALBUMIN.jpg"  title="Genia-tech"  style="border: 4px solid #666;">
        </a>
    </div>
	<br/>
     <!--   <div class="clearfix" >
