...
<body>
		...
		<div id="main">
			...
			<div class="main-holder">
				...
				<div id="content">
						...
						<div class="content">
							<div class="box">
								<h2>EQUILIBRIO CARDIOVASCULAR </h2>
										...
										<div class="container">
											...
											<div class="description-box">
												...
												<div class="text-holder">
													<p>
													El sistema renina-angiotensina (RAS) oel sistema renina-angiotensina-aldosterona (RAAS).<br>
													(RAAS) es un sistema hormonal queregula la presi&#243;n sangu&#237;neay el balance de agua(l&#237;quido). 
													La reninaactiva el sistemarenina-angiotensina mediante la escisi&#243;n del angiotensin&#243;geno, 
													producida por el h&#237;gado, para producir angiotensinaI, quese convierte posteriormente 
													enangiotensina IIpor ACE(convertidora de la Enzima angiotensina).El sitiom&#225;s importante 
													para laliberaci&#243;n de renina esel ri&#241;&#243;n.
    ...
    <div class="clearfix" style="margin-left:46px;float:left">
        <a href="imgProd/equilibrio_cardiovascular/equilibrio_cardiovascular.jpg" class="jqzoom" rel='gal1'  title="Genia-tech" >
            <img src="imgProd/equilibrio_cardiovascular/equilibrio_cardiovascular.jpg"  title="Genia-tech"  style="border: 4px solid #666;">
        </a>
