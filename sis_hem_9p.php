								...
								<div class="holder">
									<div class="frame-box">
										...
										<div class="blocks-holder blocks-subholder">
											<div class="block">
												<figure>
													<img src="imgProd/autoread.jpg" width="183" height="135" alt="" />
													
												</figure>
												<h3><a href="sis_hem_9p_autoread.php">AUTOREAD PLUS</a></h3>
													<p>
												...
												<div class="btns-holder">
													<a href="sis_hem_9p_autoread.php" class="add">Leer mas...</a>
											...
											<div class="block">
												<figure>
													<img src="imgProd/qbc.jpg" width="183" height="134" alt="" />
													
												</figure>
												<h3><a href="sis_hem_9p_qbc.php">QBC STAR</a></h3>
													<p>
													El Sistema deHematolog&#237;acentrifugo QBCSTAR&#8482;esel est&#225;ndar de oropara la realizaci&#243;n depruebas 
													de CBCen una variedadde entornos, incluyendolos laboratoriosde oficinay lugaresa distancia...
													</p>
												<!--<span class="top-new">new</span>-->
												<div class="btns-holder">
													<a href="sis_hem_9p_qbc.php" class="add">Leer mas...</a>
													<!--<a href="#" class="detail">Detail</a>-->
												</div>
											</div>
