...
<body>
										...
										<div class="container">
											...
											<div class="description-box">
												...
												<div class="text-holder">
													<p> La determinaci&#243;n de la Hemoglobina Glicada (HbA1c) se ha convertido en un eje 
													central del cuidado de la diabetes. El control de la glicemia permite evitar complicaciones 
													graves en diab&#233;ticos como fallas renales y retinopat&#237;a</p>
													Caracter&#237;sticas principales:
													<ul>
														<li>Tiempo de an&#225;lisis 3 minutos</li>
														<li>Principio: Afinidad al Boronato</li>
														<li>Exacto: No existen interferencias de variantes de Hb comunes tales como HbC y HbS.</li>
														<li>Certificaci&#243;n NGSP</li>
														<li>Preciso: Cv 5 %</li>
													...
													<div class="btns-area">
														...
														<div style="margin-right:-9px">
															<div style="width:100px; float:left;margin-right:-21px">
																<a href="http://www.genia-tech.com/demo/pdf/CATALOGO_Alere_HbA1c.pdf" target="_blank" class="more sub-more wishlist"><span>Ver </span></a>
    ...
    <div class="clearfix" style="margin-left:46px;float:left">
        <a href="imgProd/HbA1C/HbA1C.jpg" class="jqzoom" rel='gal1'  title="Genia-tech" >
            <img src="imgProd/HbA1C/HbA1C.jpg"  title="Genia-tech"  style="border: 4px solid #666;">
        </a>
