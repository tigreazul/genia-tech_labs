...
<body>
		...
		<div id="main">
			...
			<div class="main-holder">
				...
				<div id="content">
						...
						<div class="content">
							<div class="box">
								<h2>15 PARAMETROS (QBCdiagnostics)</h2>
										...
										<div class="container">
											...
											<div class="description-box">
												...
												<div class="text-holder">
													...
													Estados Unidosa mediados de 2012, el STARiutilizaun sistema patentadode hematolog&#237;aseca para proporcionar 
													un resultado de sangre completo, r&#225;pido y simpleen el consultorioen cuesti&#243;n de minutos, con caracter&#237;sticas 
													inigualablespor analizadoresrivales.Algunas de las caracter&#237;sticas delaSTARiincluyen:												
													</p>
													<ul>
														<li>F&#225;cil manejo,un solo bot&#243;n</li>
														<li>Universalde conectividad de red</li>
														<li>Guardary recuperar hasta1.000 resultadosanteriores</li>
													</ul>
													...
													<div class="btns-area">
														...
														<div style="margin-right:-9px">
															<div style="width:100px; float:left;margin-right:-21px">
																<a href="http://www.genia-tech.com/demo/pdf/CATALOGO_Qbc_starti.pdf" target="_blank" class="more sub-more wishlist"><span>Ver</span></a>
    ...
    <div class="clearfix" style="margin-left:46px;float:left">
        <a href="imgProd/15parametros/15parametros.jpg" class="jqzoom" rel='gal1'  title="Genia-tech" >
            <img src="imgProd/15parametros/15parametros.jpg"  title="Genia-tech"  style="border: 4px solid #666;">
        </a>
    </div>
	<br/>
     <!--   <div class="clearfix" >
